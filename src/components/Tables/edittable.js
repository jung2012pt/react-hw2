...
function edittable(props) {
  ...
  const updateProduct = async () => {
    ...
    let products = await localforage.getItem("movies");
    ...
    <form>
      <Tr >
          ...
          <Flex align="center" py=".8rem" minWidth="100%" flexWrap="nowrap">
            ...
            <Flex direction="column">
              ...
              <Text fontSize="sm" color="gray.400" fontWeight="normal">
                <input defaultValue={Rating} type="text" name="rating" required />
              </Text>
            </Flex>
          </Flex>
        </Td>
        ...
        <Td>
          <Flex direction="column">
            <Text fontSize="md" color={textColor} fontWeight="bold">
              <input defaultValue={Genre} type="text" name="genre" required />
            </Text>
            {/* <Text fontSize="sm" color="gray.400" fontWeight="normal">
            {Director}
          </Text> */}
        ...
        <Td>
          ...
          <Text fontSize="md" color={textColor} fontWeight="bold">
            <input defaultValue={Director} type="text" name="director" required />
          </Text>
        ...
        <Td>
          ...
          <Text fontSize="md" color={textColor} fontWeight="bold">
            <input defaultValue={Producer} type="text" name="producer" required />
          </Text>
        ...
        <Td>
          <Text fontSize="md" color={textColor} fontWeight="bold" pb=".5rem">
            <input defaultValue={StreamingDate} type="text" name="date" required />
          </Text>
        </Td>
        <Td>
